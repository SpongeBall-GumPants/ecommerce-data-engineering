...
def generate_orders(n_orders=5000, refer_pct=0.2):
    """
    Generates orders + logistics, ensuring:
     - premium users get premium logistics carriers
     - ~refer_pct of orders have a non-null refer_id from affiliate codes
    """
    os.makedirs(PROC_DIR, exist_ok=True)

    # Load CSV parents/lookups
    ...
    for i in range(n_orders):
        ...
        # pick a carrier: premium user → premium carrier
